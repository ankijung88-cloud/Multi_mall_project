...
export default function AuditionPartners() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {displayedPartners.map((partner) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <h3 className="font-bold text-xl mb-2 group-hover:text-yellow-600 transition-colors">{partner.name}</h3>
                                    ...
                                    <div className="border-t pt-4 flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-semibold text-yellow-600">{partner.schedules.length}개</span>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
                    ...
                    {displayedPartners.length === 0 && (
                        <div className="text-center py-20 bg-white rounded-xl shadow-sm">
                            <p className="text-gray-500">등록된 오디션 파트너가 없습니다.</p>
                        </div>
                    )}
                </div>
            </div>
