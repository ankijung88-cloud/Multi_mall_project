...
export default function FashionPartners() {
                ...
                <div className={clsx(
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className={clsx("text-xl max-w-2xl mx-auto", userType === 'company' ? "text-blue-200" : "text-gray-300")}>
                            K-패션의 트렌드를 선도하는 다양한 파트너사를 소개합니다.
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {displayedPartners.map((partner) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <h3 className="font-bold text-xl mb-2 group-hover:text-rose-600 transition-colors">{partner.name}</h3>
                                    ...
                                    <div className="border-t pt-4 flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-semibold text-rose-600">{partner.schedules.length}개</span>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
                    ...
                    {displayedPartners.length === 0 && (
                        <div className="text-center py-20 bg-white rounded-xl shadow-sm">
                            <p className="text-gray-500">등록된 패션 파트너가 없습니다.</p>
                        </div>
                    )}
                </div>
            </div>
