                    ...
                    {sectionPartners.map((partner) => (
                        ...
                        >
                            <motion.div
                                whileHover={{ y: -5 }}
                            >
                                <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden border border-gray-100 group-hover:border-pink-500 transition-all mb-3 shadow-sm">
                                    <img
                                        src={partner.image}
                                        alt={partner.name}
                                ...
                                <h3 className="font-bold text-lg text-gray-800 group-hover:text-pink-600 truncate px-1">
                                    {partner.name}
                                </h3>
                            </motion.div>
                        </Link>
